...
class SaleOrder(models.Model):
    ...
    sh_fully_delivered = fields.Boolean(
        string="Delivered", default=False, copy=False, compute="_compute_check_delivery", compute_sudo=True)
    sh_partially_delivered = fields.Boolean(
        string="Partially Delivered", default=False, copy=False, compute="_compute_check_delivery", compute_sudo=True)
