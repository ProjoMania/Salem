odoo.define('tis_customer_type.CustomAccountReportsWidget', function (require) {
    "use strict";
    var core = require('web.core');
    var datepicker = require('web.datepicker');
    var CustomAccountReportsWidget = require('account_reports.account_report');
    var QWeb = core.qweb;
    var _t = core._t;
...
//var CustomAccountReportsWidget = core.action_registry.get('accountReportsWidget');
CustomAccountReportsWidget.include({
...
custom_events: {
        'value_changed': function(ev) {
             ...
             self.report_options.customer_type = ev.data.customer_type;
...
render_searchview_buttons: function() {
        ...
        if (this.report_options.partner) {
            ...
            console.log("yes")
                ...
                console.log("partner_categories",Number)
                ...
                if ('customer_type' in this.report_options) {
                console.log("partner_categories")
                    fields['customer_type'] = {
                        label: _t('Customer Type'),
                        modelName: 'customer.type',
                        value: this.report_options.customer_type.map(Number),
                    };
                }
                if (!_.isEmpty(fields)) {
                    this.M2MFilters = new M2MFilters(this, fields);
                    console.log("this.M2MFilters",this.M2MFilters)
