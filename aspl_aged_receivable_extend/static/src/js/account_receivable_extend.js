odoo.define('aspl_aged_receivable_extend.test', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    events: {
        ...
        'click .currency_dropdown': '_onClickDropDownMenuCurrency',
    },
...
//                 self.$searchview_buttons.find('.account_partner_filter').click();
    ...
    _onClickDropDownMenuCurrency: function (ev) {
        var self = this
        var selectedCurrency = $(ev.currentTarget).attr('value')

        if (selectedCurrency && this.odoo_context.is_extend) {

            this.report_options.currency_id = selectedCurrency;
            ...
            this.M2MFilters._confirmChange()
        }
    },
...
core.action_registry.add('account_report_new', accountReportsWidget);
