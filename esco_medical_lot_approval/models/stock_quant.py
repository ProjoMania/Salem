...
class StockQuant(models.Model):
    ...
    @api.depends('lot_id.life_date_format')
    def _compute_life_date_format(self):
        for quant in self:
    ...
    life_date_format = fields.Char(compute='_compute_life_date_format', string='End of Life Date')
