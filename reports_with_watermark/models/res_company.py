...
class ResCompany(models.Model):
    ...
    footer_image = fields.Binary("Footer Image", attachment=True, help="This field holds the image used for footer")
    header_image = fields.Binary("Header Image", attachment=True, help="This field holds the image used for header")
